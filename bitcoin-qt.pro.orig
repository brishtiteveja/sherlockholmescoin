TEMPLATE = app
TARGET = sherlockholmescoin-qt
macx:TARGET = "sherlockholmescoin-Qt"
VERSION = 0.8.7.5
...
contains(sherlockholmescoin_NEED_QT_PLUGINS, 1) {
    DEFINES += sherlockholmescoin_NEED_QT_PLUGINS
...
contains(sherlockholmescoin_QT_TEST, 1) {
SOURCES += src/qt/test/test_main.cpp \
    src/qt/test/uritests.cpp
HEADERS += src/qt/test/uritests.h
DEPENDPATH += src/qt/test
QT += testlib
TARGET = sherlockholmescoin-qt_test
DEFINES += sherlockholmescoin_QT_TEST
