Copyright (c) 2009-2013 sherlockholmescoin Developers
...
for Ubuntu 12.04:
 ...
 db4.8 packages are available [here](https://launchpad.net/~sherlockholmescoin/+archive/sherlockholmescoin).
...
Notes
-----
The release is built with GCC and then "strip sherlockholmescoind" to strip the debug
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, sherlockholmescoin should be built with a non-executable stack
