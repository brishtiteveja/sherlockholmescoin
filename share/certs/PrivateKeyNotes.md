...
unlocked to sign the sherlockholmescoin-Qt.app bundle.
...
allowing somebody to distribute a sherlockholmescoin-Qt.app or sherlockholmescoin-qt-setup.exe with a valid
...
that the sherlockholmescoin-qt.exe file inside the installer had not been tampered with.
