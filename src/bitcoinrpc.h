...
#ifndef _sherlockholmescoinRPC_H_
#define _sherlockholmescoinRPC_H_ 1
...
// sherlockholmescoin RPC error codes
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // sherlockholmescoin is not connected
...
/**
 * sherlockholmescoin RPC command dispatcher.
 */
class CRPCTable
{
private:
