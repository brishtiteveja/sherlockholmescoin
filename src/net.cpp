...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("sherlockholmescoin-ext-ip");
...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "sherlockholmescoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"sherlockholmescointools.com", "dnsseed.sherlockholmescointools.com"},
    {"sherlockholmescoinpool.org", "dnsseed.sherlockholmescoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"sherlockholmescointools.com", "testnet-seed.sherlockholmescointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. sherlockholmescoin is probably already running."), addrBind.ToString().c_str());
        else
