...
QT_TRANSLATE_NOOP("bitcoin-core", "SherlockHolmesCoin version"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Error loading wallet.dat: Wallet requires newer version of SherlockHolmesCoin"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "SSL options: (see the SherlockHolmesCoin Wiki for SSL setup instructions)"),
QT_TRANSLATE_NOOP("bitcoin-core", "Select the version of socks proxy to use (4-5, default: 5)"),
QT_TRANSLATE_NOOP("bitcoin-core", "Send command to -server or SherlockHolmesCoind"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Specify configuration file (default: SherlockHolmesCoin.conf)"),
QT_TRANSLATE_NOOP("bitcoin-core", "Specify connection timeout in milliseconds (default: 5000)"),
QT_TRANSLATE_NOOP("bitcoin-core", "Specify data directory"),
QT_TRANSLATE_NOOP("bitcoin-core", "Specify pid file (default: SherlockHolmesCoind.pid)"),
...
QT_TRANSLATE_NOOP("bitcoin-core", "Wallet needed to be rewritten: restart SherlockHolmesCoin to complete"),
