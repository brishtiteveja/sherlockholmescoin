...
#ifndef H_sherlockholmescoin_SCRIPT
#define H_sherlockholmescoin_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CsherlockholmescoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, sherlockholmescoin always counted CHECKMULTISIGs
