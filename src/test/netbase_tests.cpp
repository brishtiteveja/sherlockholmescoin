...
{
    BOOST_CHECK(TestSplitHost("www.sherlockholmescoin.org", "www.sherlockholmescoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.sherlockholmescoin.org]", "www.sherlockholmescoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.sherlockholmescoin.org:80", "www.sherlockholmescoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.sherlockholmescoin.org]:80", "www.sherlockholmescoin.org", 80));
